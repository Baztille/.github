...
If you are discovering Baztille, these are the two core repositories:

### 🔐 Backend (core democratic logic)
👉 **https://github.com/Baztille/backend**

- Vote definition, aggregation and rules
- Data integrity and auditability
- Public APIs used by client applications
- **Licensed under AGPLv3** to guarantee transparency for any voting system
...
This organization also contains:
- forks of third-party libraries
- experimental or supporting components
- technical adaptations required by the project

These repositories exist for engineering reasons and are **not entry points** to the Baztille platform.
...
Please refer to the `CONTRIBUTING.md` file in each repository for technical guidelines and project conventions.

---

## 📄 License

Licensing depends on the repository:
- Backend: **AGPLv3**
- Application and tooling: permissive licenses (MIT / Apache)

Each repository clearly documents its own license.
